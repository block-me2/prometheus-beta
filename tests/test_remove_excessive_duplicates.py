...
def test_remove_excessive_duplicates():
    ...
    assert remove_excessive_duplicates('aaaaabbbbbccccc') == 'aabb'
    assert remove_excessive_duplicates('') == ''
    assert remove_excessive_duplicates('aaa') == ''
    assert remove_excessive_duplicates('aabbccddeeee') == 'aabbcc'

def test_remove_excessive_duplicates_mixed_chars():
    assert remove_excessive_duplicates('hello world') == 'helo world'
    assert remove_excessive_duplicates('programming') == 'programing'

def test_remove_excessive_duplicates_edge_cases():
    assert remove_excessive_duplicates('!!!@@@###') == '!!@##'
    assert remove_excessive_duplicates('123444555') == '123'
